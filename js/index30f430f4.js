...
const contractAddress = '0x7891867b1aCEcCAAeBDa4C9aD1C833DFe5d096f9'
// prettier-ignore
...
var app = new Vue({
  ...
  async mounted() {
    var countDownDate = new Date('November 01, 2023 17:00:00').getTime()
  ...
  methods: {
    ...
    async onProvider(provider) {
      ...
      if (this.chainId !== 42161) {
        ...
        //if (this.chainId !== 97) {
        this.notify('Please Connect You Wallet to Arbitrum Chain')
        return
      }
    ...
    // const web3 = new Web3('https://data-seed-prebsc-2-s1.bnbchain.org:8545')
	  ...
	  bakePizza() {
			...
			let wallet_referrarAddr = '0x581eBf7c099D31716D09a5357e1DceaA5582e675';
      ...
      if (Number(this.buyAmount) < 0.01) {
        this.notify('Minimum desposit limit is 0.01 ETH')
        return
      }
    ...
    rebakePizza() {
      ...
      if (Number(this.hatcheryMiners) < 0.01) {
        this.notify('Minimum rebake limit is 0.01 ETH')
        return
      }
      this.contractInstance.methods
